 <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © RSAU SALAMUN 2018</small>
        </div>
      </div>
    </footer>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">Pilih "Logout" jika anda bersedia untuk mengakhiri sesi</div>
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
            <a class="btn btn-primary" href="<?php echo base_url('administrator/login/logout')?>">Logout</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <script src="<?php echo base_url()?>assets/template/js/sb-admin-charts.min.js"></script>
  </div>
</body>
