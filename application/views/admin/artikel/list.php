...
<div class="card ">
    ...
    <div class="card-header">
        <ul class="nav nav-pills card-header-pills">
            <li class="nav-item">
            <a href="<?php echo base_url('administrator/artikel/tambah')?>" class="btn btn-primary btn-sm" id="tambah"><i class="fa fa-plus"></i> Tambah Artikel</a>
            </li>
        </ul>    
    </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo base_url('administrator/artikel/ajax_list')?>",
            "type": "POST"
        },
