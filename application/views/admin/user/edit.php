...
?>
<?php echo form_open(base_url('administrator/user/edit/'.$user['id_user']),array('class'=>'form-horizontal'));?>
<div class="card">
  <h5 class="card-header"><?php echo $title_panel ."<b>".$user['username']."</b>"?></h5>
  <div class="card-body">
