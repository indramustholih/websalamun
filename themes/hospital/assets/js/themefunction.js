jQuery(document).ready(function() {
	...
	jQuery("#th-locationmap").gmap3({
		...
		marker:{
			values:[
				{latLng:[48.8620722, 2.352047], data:"Paris !", options:{icon: "themes/hospital/assets/images/mapmarker.png"}},
				{address:"86000 Poitiers, France", data:"Poitiers : great city !", options:{icon: "themes/hospital/assets/images/mapmarker.png"}},
				{address:"66000 Perpignan, France", data:"Perpignan ! GO USAP !", options:{icon: "themes/hospital/assets/images/mapmarker.png"}}
			],
			options:{
				draggable: false
			},
